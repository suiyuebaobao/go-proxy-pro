<template>
  <div class="operation-logs-page">
    ...
    <div class="filter-bar">
      <el-select v-model="filters.module" clearable placeholder="模块" @change="loadLogs" style="width: 120px">
      ...
      <el-select v-model="filters.action" clearable placeholder="操作" @change="loadLogs" style="width: 120px">
